...
// static const std::string	TRX_MANAGER_ADDR		= "192.168.6.1";	// only relevant for Tranditional-SI
...
static const std::string	TRX_MANAGER_ADDR		= "10.116.60.17";	// only relevant for Tranditional-SI
static const uint16_t		TRX_MANAGER_TCP_PORT	= 45677;			// only relevant for Tranditional-SI
static const int			TRX_MANAGER_IB_PORT		= 1;	// only relevant for Tranditional-SI



// static const std::string	SERVER_ADDR[SERVER_CNT]	= {"192.168.0.1", "192.168.1.1", "192.168.2.1", "192.168.4.1"};
// static const uint16_t		TCP_PORT[SERVER_CNT]	= {45678, 45679, 45680, 45681};
// static const int			IB_PORT[SERVER_CNT]		= {1, 1, 1, 1};



static const std::string	SERVER_ADDR[SERVER_CNT]	= {"10.116.60.3", "10.116.60.2", "10.116.60.4", "10.116.60.9"};
static const uint16_t		TCP_PORT[SERVER_CNT]	= {45678, 45679, 45680, 45681};
static const int			IB_PORT[SERVER_CNT]		= {1, 1, 1, 1};
...
// static const int			IB_PORT[SERVER_CNT]		= {1};
...
static const int	TRANSACTION_CNT 		= 10000;
static const double	TRX_ARRIVAL_RATE		= 500;		// per client per second


static const int	ITEM_CNT				= 100;		// Number of Items
