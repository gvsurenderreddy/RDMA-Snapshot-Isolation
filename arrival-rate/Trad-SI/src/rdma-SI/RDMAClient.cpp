...
int RDMAClient::get_item_info(RDMAClientContext &ctx) {
...
int RDMAClient::acquire_item_lock(RDMAClientContext &ctx, uint64_t *expected_lock, uint64_t *new_lock) {
	int item_id = ctx.associated_cart_line->SCL_I_ID;
...
int RDMAClient::revert_lock(RDMAClientContext &ctx, uint64_t *new_lock) {
	int item_id		= ctx.associated_cart_line->SCL_I_ID;
...
int RDMAClient::decrement_item_stock(RDMAClientContext &ctx) {
	int item_id		= ctx.associated_cart_line->SCL_I_ID;
...
int RDMAClient::release_lock(RDMAClientContext &ctx) {
	int item_id		= ctx.associated_cart_line->SCL_I_ID;
