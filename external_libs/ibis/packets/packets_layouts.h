...
/***
 *** This file was generated at "2014-05-22 17:15:13"
 *** by:
 ***    > /mswg/release/eat_me/last_release/adabe_plugins/adb2c/adb2pack.py --input adb/packets.adb --file-prefix packets
 ***/
...
/*---------------- DWORD[3] (Offset 0xc) ----------------*/
	/* Description -  */
	/* 12.0 - 20.31 */
	 u_int64_t PortRcvCellsDropped;
/*---------------- DWORD[5] (Offset 0x14) ----------------*/
	/* Description -  */
	/* 20.0 - 28.31 */
	 u_int64_t PortRcvCrcError;
/*---------------- DWORD[7] (Offset 0x1c) ----------------*/
	/* Description -  */
	/* 28.0 - 36.31 */
...
int VendorSpec_PortLLRStatistics_size();
#define VENDORSPEC_PORTLLRSTATISTICS_SIZE    (0x80)
...
#define VENDORSPEC_GENERALINFO_SIZE    (0x80)
...
#define PM_PORTEXTENDEDSPEEDSCOUNTERS_SIZE    (0x80)
