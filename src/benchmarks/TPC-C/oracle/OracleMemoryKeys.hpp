...
#ifndef SRC_BENCHMARKS_TPC_C_ORACLE_ORACLEMEMORYKEYS_HPP_
#define SRC_BENCHMARKS_TPC_C_ORACLE_ORACLEMEMORYKEYS_HPP_
...
#endif /* SRC_BENCHMARKS_TPC_C_ORACLE_ORACLEMEMORYKEYS_HPP_ */
