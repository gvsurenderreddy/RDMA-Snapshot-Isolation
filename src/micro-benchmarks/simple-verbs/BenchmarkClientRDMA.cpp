...
#include "BenchmarkClientRDMA.hpp"
...
void BenchmarkClientRDMA::usage (const char *argv0) {
...
int BenchmarkClientRDMA::start_client () {	
...
int main (int argc, char *argv[]) {
	if (argc != 1) {
		BenchmarkClientRDMA::usage(argv[0]);
		return 1;
	}
	BenchmarkClientRDMA client;
	client.start_client();
	return 0;
}