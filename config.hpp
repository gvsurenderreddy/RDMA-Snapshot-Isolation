...
namespace config {
	...
	// static const std::string	SERVER_ADDR[SERVER_CNT]	= {"192.168.0.1", "192.168.1.1", "192.168.2.1", "192.168.3.1"};
	...
	static const size_t			TIMESTAMP_SERVER_QUEUE_SIZE = 10000;
	static const useconds_t		TIMESTAMP_CLEANUP_SLEEP_MILLISEC = 1;
