...
static const std::vector<std::string>	SERVER_ADDR = {"192.168.0.1", "192.168.1.1", "192.168.2.1"};			// IP address of the servers
static const std::vector<uint16_t>		TCP_PORT	= {45680, 45681, 45680};	// TCP port of the servers
...
/* Oracle settings */
static const std::string	TIMESTAMP_SERVER_ADDR		= "192.168.3.1";						// IP address of the oracle
...
static const int			ORACLE_READER_SLEEP_TIME	= 50;		// micro sec
...
static const size_t SERVER_PROCESSING_THREADS_CNT = 1;
}
...
/*	Database settings	*/
static const size_t WAREHOUSE_PER_SERVER		= 50;			// Number of warehouses per server
