...
#rsync -ruvh  $file erfanz@bsn00.cs.brown.edu:/data/erfanz/rdma/RDMA-Snapshot-Isolation/$dest
rsync -ruvh  $file erfanz@bsn01.cs.brown.edu:/data/erfanz/rdma/RDMA-Snapshot-Isolation/$dest
